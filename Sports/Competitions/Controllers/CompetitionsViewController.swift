...
class CompetitionsViewController: UIViewController {
    ...
    func createUI() {
        ...
        NSLayoutConstraint.activate([
            eventTableView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -5),
            eventTableView.topAnchor.constraint(equalTo: tagCollection.bottomAnchor),
