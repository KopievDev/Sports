...
class DetailCompetitionViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        descriptionLabel.text = "Отборочный тур среди всех школ Мурманска"
    ...
    @objc private func didTapRunButton() {
        ...
        NotificationManager.shared.showNotification(title: "Поздравляем!", body: "Вы записались на соревнования", identifier: "12333")
    }
